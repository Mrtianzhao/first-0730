...
public class POIUtils {
	 ...
	 * @throws IOException
	 */
	private Workbook openWorkbook(InputStream in, String filename) throws IOException {
		Workbook wb = null;
				...
				if (null != cell) {
					...
					case HSSFCell.CELL_TYPE_NUMERIC: // 数字
						...
						if ("0.00_);[Red]\\(0.00\\)".equals(cellStyleStr)) {
							...
							// } else if ((cellStyle == 181 || cellStyle ==
							// 177|| cellStyle == 176)&&
							// cellStyleStr.endsWith("@")) {
							// 星期几 Excel中的日期自定义格式 cellStyle不固定，故采用
							// "[$-804]aaaa;@"来判断
				...
				for (int n = begin; n < end; n++) {
					...
					for (int x = 0; x < headers.size(); x++) {
						...
						if (value instanceof Date) {
							 ...
							 * cell.setCellValue((String)value); }else{ }
							 */
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public void exportToExcel(HttpServletResponse response, String fileName, List objs, Class clazz, int pageSize) {
	 ...
	 * @return
	 */
	private CellStyle setCellStyle(HSSFWorkbook workbook, String position) {
