...
public class Client {
    ...
    private Logger logger = Logger.getLogger(net.dgg.framework.utils.sms.Client.class);
    /*
    * webservice服务器定义
    */
    //调用注册方法可能不成功。
    ...
    public static void main(String[] args) {
        ...
        smsContent.append("【小顶上门】您的手机验证码为：").append("5468");
        smsContent.append("，验证码有效期5分钟。");

        new net.dgg.framework.utils.sms.Client().sendMsgBatch("18380285053",smsContent.toString(),1);
    }
}
