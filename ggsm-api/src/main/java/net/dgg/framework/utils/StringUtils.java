...
public class StringUtils {
     ...
     * </pre>
     *
     * @param str 需要转换的字符串，传入的字符串必须为英语
     * @return 返回按小驼峰命名的字符串
     */
     ...
     * @param resStr      原字符串
     * @param length      总计长度
     * @param placeholder 填充内容
     * @return
     */
    public static String recruitment(int pos, String resStr, int length, String placeholder) {
